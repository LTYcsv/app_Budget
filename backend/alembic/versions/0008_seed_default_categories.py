...
DEFAULT_CATEGORIES: list[dict[str, object]] = [
    ...
    {'id': 'invest-savings', 'group': 'Инвестиции', 'name': 'Копилка', 'icon': '🐷', 'type': 'expense', 'is_other': False},
    {'id': 'invest-stocks', 'group': 'Инвестиции', 'name': 'Акции', 'icon': '📈', 'type': 'expense', 'is_other': False},
    {'id': 'invest-crypto', 'group': 'Инвестиции', 'name': 'Крипто', 'icon': '₿', 'type': 'expense', 'is_other': False},
    {'id': 'invest-other', 'group': 'Инвестиции', 'name': 'Другое', 'icon': '💼', 'type': 'expense', 'is_other': False},
